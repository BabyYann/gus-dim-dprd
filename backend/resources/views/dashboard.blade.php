    ...
    <div class="app-window"><div class="app-window-inner"><div class="app-layout">
      ...
      <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-footer">
          ...
          <button type="button" onclick="switchToMobileView()" style="margin-top:8px; width:100%; display:flex; align-items:center; justify-content:center; gap:6px; padding:6px 10px; background:#f8fafc; color:#475569; border:1px solid #e2e8f0; border-radius:8px; font-size:11.5px; font-weight:600; cursor:pointer; transition:all 0.15s;">
            <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>
            <span>Buka Versi Mobile</span>
          </button>
        </div>
      </div>
      ...
      <div class="main-content">
        ...
        <div class="topbar">
          ...
          <div class="topbar-right">
            ...
            <button type="button" class="btn-topbar-mobile-switch" onclick="switchToMobileView()" title="Beralih ke Tampilan Mobile" style="display:inline-flex; align-items:center; gap:6px; padding:6px 12px; background:#eff6ff; color:#1d4ed8; border:1px solid #bfdbfe; border-radius:8px; font-weight:600; font-size:12px; cursor:pointer; transition:all 0.2s;">
