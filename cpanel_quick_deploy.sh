...
echo "1. Impor database dari berkas dist/production_clean_schema.sql di phpMyAdmin."
echo "2. Edit backend/.env untuk mencocokkan nama database dan password cPanel Anda."
echo "3. Buka https://gusdim.com pada peramban Anda."
